<template>
  <div class="col-12" id="HomeView" :dir="this.$store.state['UserLang'] == 1 ? 'ltr' : 'rtl'">
    ...
    <div class="col-12 PageContent">
      ...
      <div class="col-12 col-sm-6 SelectField" v-if="this.TheUserSelection['PaperWeight'] != -1">
        ...
        <div class="col-12 FlexCenter"
          ...
          <div class="col-5">
            <label class="col-12">{{ this.$store.state['UserLang'] == 1 ? 'Required Width' : "العرض المطلوب" }}</label>
          ...
          <div class="col-5">
            <label class="col-12">{{ this.$store.state['UserLang'] == 1 ? 'Required Height' : "الطول المطلوب" }}</label>
      ...
      <!-- PrintingStyle -->
      <div class="col-12 col-sm-6 SelectField" v-if="this.TheUserSelection['NumberOfCopiesPerPiece'] != 0">
        <label class="col-12">
      ...
      <div class="col-12 col-sm-6 SelectField" v-if="this.TheUserSelection['ColorIndex'] != -1">
        ...
        <div class="Finish col-12">
          <div v-for="Finish, index in TheFinish" :key="Finish">
            ...
            <label :for="'Finish_' + index">{{ this.$store.state['UserLang'] == 1 ? Finish.name : Finish.ArabicName
            }}</label>
          </div>
        </div>
      </div>
    ...
    <div class="col-12 PageFooter">
      <button class="btn btn-info" @click="this.CalculateThePrice()">Calculate</button>
...
export default {
  ...
  created() {
    let main = this;
    main.FillAppInfo();
    // window.location = 'https://accounts.zoho.com/oauth/v2/auth?response_type=code&client_id=1000.R3K41GUMKFVW5K825Z6PZ6JU1HTQ3Q&scope=ZohoCRM.modules.ALL&redirect_uri=https://www.easetasks.com&prompt=consent';
    // axios.get('https://accounts.zoho.com/oauth/v2/auth', {
    //   params: {
    //     response_type: "code",
    //     client_id: '1000.R3K41GUMKFVW5K825Z6PZ6JU1HTQ3Q',
    //     scope: 'ZohoCRM.modules.ALL',
    //     redirect_uri: 'https://www.easetasks.com',
    //     prompt: 'consent'
    //   }
    // }).then(function (res) {
